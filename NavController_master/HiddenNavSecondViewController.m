//
//  HiddenNavSecondViewController.m
...
@interface HiddenNavSecondViewController ()<UITableViewDelegate, UITableViewDataSource>

@property  (nonatomic, retain) UITableView *tableView;

@end

@implementation HiddenNavSecondViewController
